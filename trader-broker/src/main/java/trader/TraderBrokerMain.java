...
public class TraderBrokerMain {
    ...
    {
        System.setProperty(TraderHomeUtil.PROP_DEFAULT_TRADER_CONFIG_NAME, "trader-broker");
    ...
    private static void processArgs(String[] args) throws Exception
    {
        ...
        CmdActionFactory actionFactory = new CmdActionFactory(beansContainer, new CmdAction[] {
                new ServiceStartAction(TraderBrokerMain.class, false)
        });
